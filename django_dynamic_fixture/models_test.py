...
class ModelForIgnoreList(models.Model):
    ...
    self_reference = models.ForeignKey('ModelForIgnoreList', on_delete=models.DO_NOTHING)
...
class ModelWithCyclicDependency(models.Model):
    d = models.ForeignKey('ModelWithCyclicDependency2', on_delete=models.DO_NOTHING)
...
class ModelWithCyclicDependency2(models.Model):
    c = models.ForeignKey(ModelWithCyclicDependency, on_delete=models.DO_NOTHING)
