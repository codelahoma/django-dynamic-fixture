...
from django_dynamic_fixture.global_settings import DDF_DEFAULT_DATA_FIXTURE, DDF_FILL_NULLABLE_FIELDS, DDF_SELF_FK_DEPTH, \
...
def fixture(**kwargs):
    ...
    f = DynamicFixture(data_fixture=kwargs.pop('data_fixture', DDF_DEFAULT_DATA_FIXTURE),
                       ...
                       self_fk_depth=kwargs.pop('self_fk_depth', DDF_SELF_FK_DEPTH),
...
def _new(model, n=1, ddf_lesson=None, persist_dependencies=False, **kwargs):
    ...
    @self_fk_depth: override DDF_SELF_FK_DEPTH global configuration. Default 1.
